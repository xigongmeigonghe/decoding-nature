...
var Enemy = function (_PlanetObject) {
  _inherits(Enemy, _PlanetObject);

  function Enemy(gameState, target) {
    var _ref;
    ...
    var _this = _possibleConstructorReturn(this, (_ref = Enemy.__proto__ || Object.getPrototypeOf(Enemy)).call.apply(_ref, [this].concat(args)));
    ...
    _this.run = function () {
      ...
      if (_this.pos.distanceTo(_this.target.pos) < 10) {
        ...
        _get(Enemy.prototype.__proto__ || Object.getPrototypeOf(Enemy.prototype), "run", _this).call(_this);
...
var EnemyGenerator = function EnemyGenerator(gameState, scene, planet, target) {
  var _this2 = this;
  ...
  this.createEnemy = function () {
    var enemy = new Enemy(_this2.gameState, _this2.target, _this2.scene, _this2.planet, _this2.planet.randomSurfacePos(), false, 4);
